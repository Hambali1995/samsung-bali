...
def check_location_match(text_upper, kotas):
    """Kota/Kabupaten DAN Kecamatan wajib sama-sama muncul di pesan."""
    for k in kotas:
        ...
        # Jangan pernah meloloskan "Semua Kecamatan" hanya berdasarkan kota.
    ...
    try:
        ...
        for uid_str, uinfo in fresh_db.get("user_info", {}).items():
            try:
                ...
                # WAJIB cocok wilayah lengkap (KOTA/KABUPATEN + KECAMATAN).
                # Keyword tidak boleh menjadi jalan pintas untuk mengirim pesan
                # hanya karena nama kota/kabupaten muncul di pesan.
                if not is_match:
                    continue

                # Kirim notifikasi jika lokasi lengkap cocok dan langganan aktif.
                if is_match:
