...
def load_db():
    ...
    for p in [DB_FILE_PERSISTENT, DB_FILE]:
        try:
            ...
            continue
    return {"user_info": {}, "langganan": {}, "langganan_cari": {}, "blacklist": [], "pantauan": [], "pending_hapus_kota": []}
...
# ========== NO PANTAUAN (AMAN) ==========
# Data NO PANTAUAN TIDAK boleh dihapus otomatis saat bot restart/deploy.
# Sumber data digabung dari Supabase, DB lokal, dan file backup.

def get_all_pantauan():
    try:
        remote = load_pantauan_from_supabase()
    except Exception:
        remote = None
    ...
    try:
        backup = load_pantauan_backup() or []
    except Exception:
        backup = []
    ...
    # Normalisasi dan hapus duplikat tanpa menghapus data valid.
    cleaned = []
    seen = set()
